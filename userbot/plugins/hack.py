...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd==953414679:
            ...
            "`Hacking... 84%\n█████████████████████▒▒▒▒ `",
            "`Hacking... 100%\n█████████HACKED███████████ `",
            "`Targeted Account Hacked...\n\nPay 99.99$ To` @therealApr `To Remove this hack..`"
            ]
